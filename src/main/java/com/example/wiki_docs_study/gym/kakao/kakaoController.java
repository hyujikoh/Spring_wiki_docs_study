...
import com.example.wiki_docs_study.config.BaseException;
...
public class kakaoController {
    ...
    public GetAddressRes showList(){
        List<GetAddressResInterface> reslut = this.kakaoRepository.findyGymList();
        GetAddressRes getAddressRes = new GetAddressRes();
        getAddressRes.setPositions(reslut);
//        System.out.println(getAddressRes.getPositions().get(0).getGym_name());
